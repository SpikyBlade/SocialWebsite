...
<div class="main_column column">
   ...
   <form action="settings-display.php" method="POST">
      <input type="submit" name="update_details_display" id="save_details" value="Update Details" class="info settings_submit"><br>
   </form>
