...
<div class="main_column column">
   ...
   <form action="settings-privacy.php" method="POST">
      <input type="submit" name="update_details_privacy" id="save_details" value="Update Details" class="info settings_submit"><br>
   </form>
